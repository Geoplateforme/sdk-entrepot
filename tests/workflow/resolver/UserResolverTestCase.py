...
class UserResolverTestCase(GpfTestCase):
    ...
    def test_ok_without_info(self) -> None:
        """test unitaire pour vérifier s'il ne plante pas s'il n'y a pas de données utilisateur"""
        ...
        # La clef last_name doit passer même sans avoir été retournée par l'API
        self.assertEqual(o_resolver.resolve("last_name"), "last_name")
