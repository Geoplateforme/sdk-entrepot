...
class ApiRequesterTestCase(GpfTestCase):
    ...
    def test_range_total_page(self) -> None:
        ...
        self.assertTrue(ApiRequester.range_total_page("1-5/10", 5), 2)
        # Content-Range nul : on renvoie 0
        self.assertFalse(ApiRequester.range_total_page(None, 5), 0)
        # Content-Range non parsable : on renvoie 0
        self.assertFalse(ApiRequester.range_total_page("non_parsable", 5), 0)
